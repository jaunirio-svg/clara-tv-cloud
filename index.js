...
app.get('/', (req, res) => {
    res.send(`
        ...
        <head>
            ...
            <title>CLARA TV CLOUD V19</title>
            <style>
                ...
                .live-dot { height: 8px; width: 8px; background-color: #ff0000; border-radius: 50%; display: inline-block; margin-right: 5px; animation: blink 1s infinite; }
                @keyframes blink { 50% { opacity: 0.3; } }
            </style>
        </head>
        <body>
            <header><h1>⭐ CLARA <span style="color:white">TV CLOUD V19</span></h1></header>
            ...
            <div class="container">
                <div class="category"><span class="live-dot"></span> CANAIS ABERTOS BRASIL</div>
                <div class="grid">
                    <button class="active" onclick="ch('UCvYyI6I6YI6I_6YI6A', this)">SBT AO VIVO</button>
                    ...
                    <button onclick="ch('UCW0S2y6C-yGv6p0-YV6I6A', this)">TV CÂMARA</button>
                </div>

                <div class="category">🎬 CINEMA & ENTRETENIMENTO 24H</div>
                <div class="grid">
...
app.listen(PORT, () => console.log('🚀 CLARA V19 NO AR!'));
